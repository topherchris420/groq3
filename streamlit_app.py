...
st.set_page_config(page_icon="images/1920x1080bb-80.png", layout="wide", page_title="DigiDopps™")
...
icon("🫂")
st.markdown('<a href="https://visualverse.streamlit.app/" style="text-decoration:none; color: #ADD8E6;"><h2>Vers3Dynamics</h2></a>', unsafe_allow_html=True)
